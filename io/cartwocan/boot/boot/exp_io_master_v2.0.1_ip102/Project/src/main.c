...
int main(void)
{
    ...
    if ((app_flag != 0x00AA) || (DIP8_STATE == 0) || (BKP_ReadBackupRegister(BKP_DR8)==0x55))
    {
         TFTP_IAP();
    }
    else
...
//        vcan_sendmsg_one(buff,5,CAN_FUNC_ID_BOOT_MODE,2);
//        vcan_sendmsg_two(buff,5,CAN_FUNC_ID_BOOT_MODE,2);
    }
}
/**
