...
void USART_Configuration(void)
{
    ...
    USART_Init(MOTO_THREE_UART, &USART_InitStructure);
    USART_DMACmd(MOTO_THREE_UART, USART_DMAReq_Tx, DISABLE);
    USART_DMACmd(MOTO_THREE_UART, USART_DMAReq_Rx, ENABLE);
    USART_ITConfig(MOTO_THREE_UART, USART_IT_IDLE, ENABLE);

    USART_Cmd(MOTO_THREE_UART, ENABLE);
    ...
    USART_Init(MOTO_ONE_USART, &USART_InitStructure);
    USART_DMACmd(MOTO_ONE_USART, USART_DMAReq_Tx, DISABLE);
    USART_DMACmd(MOTO_ONE_USART, USART_DMAReq_Rx, ENABLE);
    USART_ITConfig(MOTO_ONE_USART, USART_IT_IDLE, ENABLE);

    USART_Cmd(MOTO_ONE_USART, ENABLE);
    ...
    USART_Init(MOTO_TWO_USART, &USART_InitStructure);
    USART_DMACmd(MOTO_TWO_USART, USART_DMAReq_Tx, DISABLE);//USART_DMACmd(DEBUG_USART, USART_DMAReq_Tx, DISABLE);   //
    USART_DMACmd(MOTO_TWO_USART, USART_DMAReq_Rx, ENABLE);
    USART_ITConfig(MOTO_TWO_USART, USART_IT_IDLE, ENABLE);

    USART_Cmd(MOTO_TWO_USART, ENABLE);
}
...
void DMA_Configuration(void)
{
    ...
    DMA_InitStructure.DMA_BufferSize = UART4_BUFF_LEN;
    ...
    DMA_InitStructure.DMA_MemoryBaseAddr = (u32)usart1_send_buff;
    DMA_InitStructure.DMA_DIR = DMA_DIR_PeripheralDST;
    ...
    DMA_InitStructure.DMA_MemoryBaseAddr = (u32)usart1_recv_buff;
    DMA_InitStructure.DMA_DIR = DMA_DIR_PeripheralSRC;
    DMA_InitStructure.DMA_BufferSize = USART1_BUFF_LEN;
    DMA_InitStructure.DMA_PeripheralInc = DMA_PeripheralInc_Disable;
    DMA_InitStructure.DMA_MemoryInc = DMA_MemoryInc_Enable;
    ...
    DMA_InitStructure.DMA_MemoryBaseAddr = (u32)usart2_send_buff;
    DMA_InitStructure.DMA_DIR = DMA_DIR_PeripheralDST;
    ...
    DMA_InitStructure.DMA_PeripheralBaseAddr = (u32)(&USART2->DR);//USART4_DR_Base;
    DMA_InitStructure.DMA_MemoryBaseAddr = (u32)usart2_recv_buff;
    DMA_InitStructure.DMA_DIR = DMA_DIR_PeripheralSRC;
    DMA_InitStructure.DMA_BufferSize = USART2_BUFF_LEN;
    DMA_InitStructure.DMA_PeripheralInc = DMA_PeripheralInc_Disable;
    DMA_InitStructure.DMA_MemoryInc = DMA_MemoryInc_Enable;
...
void System_Setup(void)
{
    ...
    RCC_APB1PeriphClockCmd(RCC_APB1Periph_BKP | RCC_APB1Periph_TIM2 | RCC_APB1Periph_USART2 | RCC_APB1Periph_UART4 | RCC_APB1Periph_UART5
                           | RCC_APB1Periph_PWR | RCC_APB1Periph_CAN1 | RCC_APB1Periph_CAN2, ENABLE);
...
void NVIC_Configuration(void)
{
    ...
    NVIC_InitStructure.NVIC_IRQChannel = DMA1_Channel5_IRQn;   // 发送DMA通道的中断配置
    ...
    NVIC_InitStructure.NVIC_IRQChannel = DMA1_Channel6_IRQn;    // 发送DMA通道的中断配置
    NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = 0;   // 优先级设置
    NVIC_InitStructure.NVIC_IRQChannelSubPriority = 1;
    NVIC_InitStructure.NVIC_IRQChannelCmd = ENABLE;
    NVIC_Init(&NVIC_InitStructure);
