...
#define  DIP_1_STATE            GPIO_ReadInputDataBit(GPIOF,GPIO_Pin_10)
#define  DIP_2_STATE            GPIO_ReadInputDataBit(GPIOG,GPIO_Pin_6)
#define  DIP_3_STATE            GPIO_ReadInputDataBit(GPIOG,GPIO_Pin_12)
#define  DIP_4_STATE            GPIO_ReadInputDataBit(GPIOD,GPIO_Pin_4)
#define  DIP_5_STATE            GPIO_ReadInputDataBit(GPIOD,GPIO_Pin_14)
#define  DIP_6_STATE            GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_7)
#define  DIP_7_STATE            GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_11)
#define  DIP_8_STATE            GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_13)
