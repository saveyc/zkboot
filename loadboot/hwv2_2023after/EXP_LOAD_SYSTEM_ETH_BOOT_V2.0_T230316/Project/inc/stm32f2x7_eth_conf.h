...
/* PHY Reset delay */ 
#define PHY_RESET_DELAY    ((uint32_t)0x0005FFFF) 
/* PHY Configuration delay */ 
#define PHY_CONFIG_DELAY   ((uint32_t)0x0005FFFF)
...
#define PHY_SPEED_STATUS            ((uint16_t)0x4000) /* Value for DP83848 PHY */
#define PHY_DUPLEX_STATUS           ((uint16_t)0x2000) /* Value for DP83848 PHY */
